...
def port_ctp_td():
    meta = {}
    walk_hpp(open("./api/6.6.1_P1_linux64/ThostFtdcTraderApi.h", encoding="gbk").read(), meta)

    with open("./src/ctp_td.cpp", "w", encoding="utf-8") as file: 
        file.writelines(["#include \"../api/6.6.1_P1_linux64/ThostFtdcTraderApi.h\""])
...
def port_ctp_md():
    meta = {}
    walk_hpp(open("./api/6.6.1_P1_linux64/ThostFtdcMdApi.h", encoding="gbk").read(), meta)

    with open("./src/ctp_md.cpp", "w", encoding="utf-8") as file: 
        file.writelines(["#include \"../api/6.6.1_P1_linux64/ThostFtdcMdApi.h\""])
