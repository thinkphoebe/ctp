...
PyObject *CTP_THOST_FTDC_TRADER_API_RegisterUserSystemInfo(PyObject *self, PyObject *args);

///上报用户终端信息，用于中继服务器操作员登录模式
///操作员登录后，可以多次调用该接口上报客户信息
PyObject *CTP_THOST_FTDC_TRADER_API_SubmitUserSystemInfo(PyObject *self, PyObject *args);
...
///查询用户当前支持的认证模式
PyObject *CTP_THOST_FTDC_TRADER_API_ReqUserAuthMethod(PyObject *self, PyObject *args);

///用户发出获取图形验证码请求
PyObject *CTP_THOST_FTDC_TRADER_API_ReqGenUserCaptcha(PyObject *self, PyObject *args);

///用户发出获取短信验证码请求
PyObject *CTP_THOST_FTDC_TRADER_API_ReqGenUserText(PyObject *self, PyObject *args);

///用户发出带有图片验证码的登陆请求
PyObject *CTP_THOST_FTDC_TRADER_API_ReqUserLoginWithCaptcha(PyObject *self, PyObject *args);

///用户发出带有短信验证码的登陆请求
PyObject *CTP_THOST_FTDC_TRADER_API_ReqUserLoginWithText(PyObject *self, PyObject *args);

///用户发出带有动态口令的登陆请求
PyObject *CTP_THOST_FTDC_TRADER_API_ReqUserLoginWithOTP(PyObject *self, PyObject *args);
...
///请求查询二级代理商信息
PyObject *CTP_THOST_FTDC_TRADER_API_ReqQrySecAgentTradeInfo(PyObject *self, PyObject *args);
